...
@property unsigned long long mode; // @synthesize mode;
...
@property __weak id <WAProgressHUDDelegate> delegate; // @synthesize delegate;
@property unsigned long long animationType; // @synthesize animationType;
- (void).cxx_destruct;
