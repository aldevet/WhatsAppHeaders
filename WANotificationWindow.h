...
@interface WANotificationWindow : UIWindow
{
    ...
    _Bool _useStaticBlurBackground;
    _Bool _useLiveBlurBackground;
...
+ (id)sharedWindow;
+ (struct CGAffineTransform)windowTransformForInterfaceOrientation:(long long)arg1;
+ (struct CGRect)windowFrameForInterfaceOrientation:(long long)arg1;
...
@property(nonatomic) _Bool forcedToHide; // @synthesize forcedToHide=_forcedToHide;
...
@property(nonatomic) __weak id <WANotificationWindowDelegate> delegate; // @synthesize delegate=_notificationDelegate;
- (void).cxx_destruct;
- (struct CGRect)backgroundViewFrameForInterfaceOrientation:(long long)arg1;
...
- (void)postWAMessage:(id)arg1 duration:(double)arg2 animated:(_Bool)arg3;
