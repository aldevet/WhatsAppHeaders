...
@property(nonatomic) double reg_wait; // @synthesize reg_wait=_reg_wait;
@property(nonatomic) double reg_activity; // @synthesize reg_activity=_reg_activity;
...
@property(nonatomic) double reg_register_type; // @synthesize reg_register_type=_reg_register_type;
...
@property(nonatomic) double reg_last_platform; // @synthesize reg_last_platform=_reg_last_platform;
@property(retain, nonatomic) NSString *reg_last_app_version; // @synthesize reg_last_app_version=_reg_last_app_version;
